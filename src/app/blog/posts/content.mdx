...
Replace the `public/images/me.jpg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
...
`const home = {
    label: "Home",
    title: "Adetayo Adebayo's Portfolio",
    description: "Portfolio website showcasing my work as a Platform Engineer",
    headline: <>Platform Engineer and builder</>,
    subline: (
      <>
        I'm Adetayo, a Platform Engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
